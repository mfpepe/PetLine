...
public class AltaRecordatorioAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			sessRecordatorio.insertarRecordatorio(recordatorio);
			target = "success";
			message = "Recordatorio fue dado de alta exitosamente";
		} catch (Exception e) {
			target = "failure";
			message = "Ocurrio un error al dar de alta Recordatorio.\n" + e.getMessage();
		}
