...
<form method="post" name="form1" id="form1" action="BajaRecordatorio.do">
		...
		<table class=table2 >
			...
			<tr>
				...
				<td>&nbsp;<input type="text" name="fecha" id="fecha" value="<%= (new SimpleDateFormat("dd/MM/yyyy")).format(recordatorio.getFechaHora().getTime()) %>"  disabled/></td>
			<tr>
			<tr>
				<td class=etiqueta>Hora</td>
				<td>&nbsp;<input type="text" name="hora" id="hora" value="<%= (new SimpleDateFormat("HH:mm")).format(recordatorio.getFechaHora().getTime()) %>"  disabled/></td>
			<tr>		
			<tr>
